...
export default function PremiumBadge({ size = 18, label = "Profil Premium" }) {
  ...
  return (
    <span title={label} aria-label={label} style={{ display: "inline-flex", alignItems: "center", gap: 5, minHeight: size + 8, padding: "3px 8px 3px 4px", borderRadius: 999, background: "#FFF8E7", border: "1px solid #E8D39A", color: "#795A16", fontSize: textSize, fontWeight: 750, letterSpacing: "0.04em", lineHeight: 1, whiteSpace: "nowrap", boxShadow: "0 2px 6px rgba(121,90,22,0.1)" }}>
