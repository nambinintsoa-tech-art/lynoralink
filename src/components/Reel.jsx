      ...
      <div style={{ display: "flex", gap: 10 }}>
        ...
        <div style={{ flex: 1, minWidth: 0 }}>
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 4, flexWrap: "wrap" }}>
            ...
            {isReelAuthorComment && <span title="Auteur du reel" style={{ display: "inline-flex", alignItems: "center", gap: 5, padding: 0, background: "transparent", border: "none", color: LC.navy900, fontSize: 10, fontWeight: 800, whiteSpace: "nowrap", lineHeight: 1 }}><Pencil size={10} strokeWidth={2.5} style={{ color: LC.navy900 }} />Auteur</span>}
